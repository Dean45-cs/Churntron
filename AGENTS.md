...
ist ausgebaut, die Einwand-Wiki (Stage 6) läuft, Konten samt Profilen (Stage 7) stehen,
und aus Stage 3 läuft der Gesprächsleitfaden. Import, die übrige Churn-Fachlogik und die
