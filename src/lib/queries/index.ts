 ...
 *
 * Die Abfragen des Provisionsmoduls, der Duelle und der Einwand-Wiki stehen
 * wegen des Umfangs in den Nachbardateien commissions.ts, duels.ts und
 * objections.ts und werden hier wieder mit ausgegeben – fuer die Seiten bleibt
 * es bei einem einzigen Import aus '@/lib/queries'.
 *
